        ...
        <form className={s.edit_profile_form} onSubmit={handleSubmit}>
          ...
          <div className={s.edit_profile_inputs}>
            ...
            <div className={s.edit_profile_rigth}>
              ...
              <input onChange={handleChange} className={errors.facebook ? s.Alert : s.Inputs} type="text" placeholder="Facebook" name="facebook" value={input.facebook}/>
              {
                errors.facebook && errors.facebook
              }
              
              <input onChange={handleChange} className={errors.instagram ? s.Alert : s.Inputs} type="text" placeholder="Instagram" name="instagram" value={input.instagram}/>
              {
                errors.instagram && errors.instagram
              }
              
              <input onChange={handleChange} className={errors.linkedIn ? s.Alert : s.Inputs} type="text" placeholder="LinkedIn" name="linkedIn" value={input.linkedIn}/>
              {
