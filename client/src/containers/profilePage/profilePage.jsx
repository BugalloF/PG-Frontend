      ...
      <div>
        <div className={s.container_info_profile}>
          ...
          <div className={s.social_media}>
            {user?.found?.facebook?(<a href={`https:/${user.found.facebook}`} target="_blank"><FontAwesomeIcon className={s.facebook} icon={faFacebook} /></a>):null}
            {user?.found?.instagram?(<a href={`https:/${user.found.instagram}`} target="_blank"><FontAwesomeIcon className={s.instagram} icon={faInstagram} /></a>):null}
            {user?.found?.linkedIn?(<a href={`https:/${user.found.linkedIn}`} target="_blank"><FontAwesomeIcon className={s.linkedin} icon={faLinkedin} /></a>):null}
            {user?.found?.deviantart?(<a href={`https:/${user.found.deviantart}`} target="_blank"><FontAwesomeIcon className={s.deviantart} icon={faDeviantart} /></a>):null}
          </div>
        </div>
